...
from arc_rl.modules import ActorCritic
...
class APPO:
    ...
    def update(self):  # noqa: C901
        ...
        for (
            ...
            if self.desired_kl is not None and self.schedule == "adaptive":
                with torch.inference_mode():
                    ...
                    if self.gpu_global_rank == 0:
                        ...
                        # print(f"[KL] kl_mean: {kl_mean.item():.6f}, desired_kl: {self.desired_kl}, actor_lr: {self.actor_learning_rate}") ## HERE
                    ...
                    for param_group in self.actor_optimizer.param_groups:
                        ...
                        # print("Current actor LR:", param_group["lr"]) ## HERE
            ...
            #         print(f"Grad OK for {name}, norm={param.grad.norm():.6f}")
            #     else:
